...
export const yesTextPresets = [
    { id: 'mutual', text: 'Ура!! 🎉💕 Это взаимно!!!' },
    { id: 'best', text: 'Ура!! 🎉💕 Ты — лучшее, что случилось!' },
    { id: 'destiny', text: 'Ура!! 🎉💕 Так и должно было быть!' },
    { id: 'heartbeat', text: 'Ура!! 🎉💕 Сердце бьётся как сумасшедшее!' },
    { id: 'date', text: 'Ура!! 🎉💕 А я уже готовлю свидание!' },
    { id: 'brighter', text: 'Ура!! 🎉💕 Мир стал ярче на 1000%!' },
];
